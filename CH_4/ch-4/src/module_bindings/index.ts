...
import GuessResultRow from "./guess_result_table";
...
const tablesSchema = __schema({
  ...
  guessResult: __table({
    name: 'guess_result',
    indexes: [
      { accessor: 'id', name: 'guess_result_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'round', name: 'guess_result_round_idx_btree', algorithm: 'btree', columns: [
        'round',
      ] },
    ],
    constraints: [
      { name: 'guess_result_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, GuessResultRow),
  player: __table({
    name: 'player',
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("start_new_round", StartNewRoundReducer),
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `gameState` instead. This alias will be removed in the next major version. */
    readonly "game_state": Omit<typeof tablesSchema.schemaType.tables["gameState"], "accessorName"> & { readonly accessorName: "game_state" };
    /** @deprecated Use `guessResult` instead. This alias will be removed in the next major version. */
    readonly "guess_result": Omit<typeof tablesSchema.schemaType.tables["guessResult"], "accessorName"> & { readonly accessorName: "guess_result" };
  };
};
...
export type DbView = __DbViewBase & {
  /** @deprecated Use `gameState` instead. This alias will be removed in the next major version. */
  readonly "game_state": __DbViewBase["gameState"];
  /** @deprecated Use `guessResult` instead. This alias will be removed in the next major version. */
  readonly "guess_result": __DbViewBase["guessResult"];
};

type __TablesBase = __QueryBuilder<typeof tablesSchema.schemaType>;
export type Tables = __TablesBase & {
  /** @deprecated Use `gameState` instead. This alias will be removed in the next major version. */
  readonly "game_state": __TablesBase["gameState"];
  /** @deprecated Use `guessResult` instead. This alias will be removed in the next major version. */
  readonly "guess_result": __TablesBase["guessResult"];
};
